 ...
 *  while raw motion is better for controlling for example a 3D oldcamera.  Because
 ...
 *
 *  __Do not use this function__ to implement things like oldcamera controls.  GLFW
